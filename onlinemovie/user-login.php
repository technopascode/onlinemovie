...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>CinephileHub-Login</title>
        ...
        <div class="container">
          ...
          <div class="jumbotron">
            ...
            <form class="" action="Plogin.php" method="POST"> <br><br>
              <input type="email" class="form-control" placeholder="Usename/ Email Address" name="username" value="">
              <br>
              <input type="password" class="form-control" placeholder="Password" name="passwd" value="">
              <br><br>
