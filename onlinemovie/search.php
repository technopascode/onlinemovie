...
<head>
  <meta charset="utf-8">
  <title>CinephileHub-Homepage</title>
    ...
    <ul class="navbar-nav">
      ...
      if (isset($_SESSION['id'])) {
        if ($_SESSION['id'] == 1) {
          ...
          echo "<li class='update_button'> <a href='update-movie.php' class='update_button'>update movie</a> </li>";
            echo "<li class='Delete_button'> <a href='delete-movie.php' class='Delete_button'>Delete movie</a> </li>";
        }
      }
      ...
      echo"<h1>WELCOME </h1><i style = 'color: white;font-size: 25px'> ".ucwords($rel['name'])." !</i>
        ...
        <div class='row'>
          <div class='col'>
            ...
            <input type='submit' name='submit' class='btn btn-success' style='display:inline;width:200px;margin-left:20px;margin-right:20px;' value='".(isset($rel2['name']) ? ucwords($rel2['name']) : "")."'/></h4>
            </form>
          </div>
          <div class='col'>
...
<div class="footer-copyright text-center py-3">©2024 Copyright:
  <a href="">jair.pawirodinomo@student.natin.sr</a>
</div>
