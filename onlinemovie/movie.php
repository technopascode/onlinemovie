...
if (isset($_POST['submit'])) {
    $title = $_POST['submit'];
    include 'dbh.php';
    $im = "SELECT m.*, g.name AS genre_name
           FROM movies m
    ...
    while ($result = mysqli_fetch_assoc($records)) {
        ...
        $newcount = $current + 1;
        $newsql = "UPDATE movies SET viewers = '$newcount' WHERE title = '$mname'";
        ...
        echo "<br><br><h5 style='display: inline;'><br>movie name : </h5><h1 style='display: inline;'>" . ucwords($result['title']) . "</h1>";
        echo "<br><h5 style='display: inline;' >genre : </h5><h4 style='display: inline;'>" . ucwords($result['genre_name']) . "</h4>";
        echo "<br><h5 style='display: inline;' >release year : </h5><h4 style='display: inline;'>" . $result['release_year'] . "</h4>";
